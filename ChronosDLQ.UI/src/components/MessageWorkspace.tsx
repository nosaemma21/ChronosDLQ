          ...
          <div className="flex shrink-0 items-start justify-between gap-4 border-b-2 border-[#263e56] pb-3">
            ...
            <div className="flex shrink-0 gap-2">
              <button
                ...
                className="pixel-button pixel-title cursor-pointer bg-[#8f4f52] px-3.5 py-1.5 text-base font-bold leading-none text-[#1f0b0d] transition-all hover:bg-[#b86c6f] disabled:bg-[#263849] disabled:text-[#6d8fb0]"
              >
              ...
              <button
                onClick={onReplay}
                disabled={anyActiveNetworkAction}
                className="pixel-button pixel-title cursor-pointer bg-[#79d957] px-3.5 py-1.5 text-base font-bold leading-none text-[#10210d] transition-all hover:bg-[#9cff78] disabled:bg-[#263849] disabled:text-[#6d8fb0]"
              >
